    ...
    <main>
        ...
        <section class="hero-zombie">
            ...
            <div class="hero-zombie-content">
                <h2>What's that</h2>
                <h1>ROBLOX</h1>
                <p>Roblox là nền tảng game sáng tạo cho phép bạn xây dựng thế giới và chơi hàng triệu game do cộng đồng tạo ra.</p>
            </div>
        </section>
        <!-- Slider Section -->
        ...
        <section class="detail-section" id="detailSection">
            ...
            <div class="detail-info">
                <div class="category" id="detailCategory">SANDBOX</div>
                <h2 id="detailTitle">ROBLOX - SANDBOX</h2>
                <div class="meta" id="detailMeta">Release: 2006 | Genre: Sandbox</div>
                <div class="desc" id="detailDesc"><b>SHORT DESCRIPTION</b><br>Roblox là một vũ trụ ảo nơi bạn có thể sáng tạo, chia sẻ trải nghiệm và phiêu lưu cùng bạn bè.</div>
        ...
        const games = [
            {
                ...
                price: '$19.99',
                img: '/Baygorn1/asset/img/game_roblox.jpg',
                category: 'SANDBOX',
            ...
            },
            {
                ...
                price: '$29.99',
                img: '/Baygorn1/asset/img/minecraft.jpg',
                category: 'SANDBOX',
            ...
            },
            {
                ...
                price: '$9.99',
                img: '/Baygorn1/asset/img/game_tft_1.jpg',
                category: 'AUTO CHESS',
            ...
            },
            {
                ...
                price: '$39.99',
                img: '/Baygorn1/asset/img/game_i_am_legion.jpg',
                category: 'ACTION',
            ...
            },
            {
                ...
                price: '$49.99',
                img: '/Baygorn1/asset/img/game_palworld.jpeg',
                category: 'ADVENTURE',
