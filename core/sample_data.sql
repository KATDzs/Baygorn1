...
INSERT INTO games (title, description, detail_desc, platform, price, image_url, modified_by, status, meta) VALUES
('Minecraft', 'Game thế giới mở với đồ họa khối', 'Khám phá thế giới vô tận, xây dựng và sáng tạo trong một thế giới được tạo ra từ các khối. Sinh tồn qua những đêm đầy quái vật hoặc xây dựng những công trình vĩ đại trong chế độ sáng tạo.', 'PC, Mobile, Console', 720000, 'minecraft.jpg', 1, 'active', '{"genre": "Sandbox", "publisher": "Mojang", "release_date": "2011-11-18"}'),
('Roblox', 'Nền tảng game trực tuyến và hệ thống tạo game', 'Roblox là nền tảng cho phép người chơi tham gia và tạo ra vô số trò chơi khác nhau. Với cộng đồng sáng tạo lớn, Roblox cung cấp trải nghiệm game đa dạng và phong phú.', 'PC, Mobile, Console', 0, 'game_roblox.jpg', 1, 'active', '{"genre": "Platform", "publisher": "Roblox Corporation", "release_date": "2006-09-01"}'),
('Palworld', 'Game sinh tồn thế giới mở với các sinh vật Pal', 'Khám phá thế giới kỳ diệu với những sinh vật gọi là "Pal". Thu thập, huấn luyện và chiến đấu cùng Pal trong hành trình sinh tồn đầy thú vị. Xây dựng căn cứ và phát triển đội hình Pal của riêng bạn.', 'PC', 1440000, 'game_palworld.jpeg', 1, 'active', '{"genre": "Survival", "publisher": "Pocketpair", "release_date": "2024-01-19"}'),
('Team Fortress', 'Game bắn súng đội nhóm hành động', 'Game bắn súng góc nhìn thứ nhất với 9 class nhân vật độc đáo. Mỗi class có những kỹ năng và vai trò riêng biệt, tạo nên những trận chiến chiến thuật gay cấn.', 'PC', 480000, 'game_tf.jpg', 1, 'active', '{"genre": "FPS", "publisher": "Valve", "release_date": "2007-10-10"}'),
('I Am Legion', 'Game chiến thuật ma quỷ', 'Trở thành chúa tể bóng tối trong game chiến thuật độc đáo. Chỉ huy đội quân quỷ dữ và mở rộng lãnh địa của bạn trong thế giới đen tối.', 'PC', 600000, 'game_i_am_legion.jpg', 1, 'active', '{"genre": "Strategy", "publisher": "Dark Games", "release_date": "2024-02-01"}'),
('Brain Rot Evolution', 'Game sinh tồn zombie độc đáo', 'Sinh tồn trong thế giới hậu tận thế với những zombie tiến hóa. Kết hợp yếu tố sinh tồn và chiến thuật, người chơi phải thích nghi và phát triển để tồn tại.', 'PC', 384000, 'brainrotevolution.webp', 1, 'active', '{"genre": "Survival", "publisher": "Zombie Studios", "release_date": "2024-01-15"}');
